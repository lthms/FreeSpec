...
(** We now introduce the notion of so-called correct run, to reason
    about the execution of a correct program without the need to use a
    compliant specification. [correct_run] is a predicate which maps a
    program with a set of possible results, along with a set of
    possible resulting witness state. *)
