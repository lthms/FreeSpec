...
Hint Constructors doors_o_caller : smram.
...
Hint Constructors doors_o_callee : smram.
...
Proof.
  ...
  prove impure with smram; subst; constructor.
...
Hint Resolve close_door_respectful : smram.
...
Hint Resolve open_door_respectful : smram.
...
Hint Resolve close_door_run : smram.
...
Proof.
  ...
  assert (hpre : pre (to_hoare doors_contract (controller a e)) ωd)
    by  (destruct e; prove impure with smram).
  split; auto.
  intros x ωj' run.
  cbn.
  split.
