...
(** We use an alternative definition of [derive_semantics], which has the
    virtue of being easier to reason with. *)
...
(** We prove these two definition ([derive_semantics] and [derive_semantics'])
    are equivalent wrt. [semantics_eq]. *)
