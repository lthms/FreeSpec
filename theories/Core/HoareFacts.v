From FreeSpec.Core Require Import Interface hoare_tactics ImpureFacts Contract.
...
Lemma to_hoare_cplus `{Provide ix i, Provide ix j}
...
Hint Resolve to_hoare_cplus : freespec.
